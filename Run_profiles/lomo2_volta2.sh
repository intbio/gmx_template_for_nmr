...
ssh $1 "module load slurm gromacs/2020.3-mpi-gpu; cd ~/_scratch/$2/GMX_run; sbatch -p volta2 -t 2-00:00:00 -N 1 -J $2 lomo2_run_volta2.sh 7_prod"
...
ssh $1 "module load slurm gromacs/2020.3-mpi-gpu; cd ~/_scratch/$2/GMX_run; sbatch -p test -t 00:15:00 -N $4 -J $2 lomo2_run_volta2.sh $3 test"
...
relaunch() {
echo Params: $1 $2
ssh $1 "module load slurm gromacs/2020.3-mpi-gpu; cd ~/_scratch/$2/GMX_run; sbatch -p volta2 -t 2-00:00:00 -N 1 -J $2 lomo2_run_volta2_cont.sh 7_prod"
}
