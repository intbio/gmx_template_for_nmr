...
ssh $1 "module load slurm  gromacs/2020.3-mpi-gpu; cd ~/_scratch/$2/GMX_run_prep; sbatch -p compute -t 7-00:00:00 -N 4 -J $2 lomo2_run_compute.sh 7_prod"
...
relaunch() {
echo Params: $1 $2
ssh $1 "module load slurm  gromacs/2020.3-mpi-gpu; cd ~/_scratch/$2/GMX_run_prep; sbatch -p compute -t 7-00:00:00 -N 4 -J $2 lomo2_run_compute_cont.sh 7_prod"
}

add_chain_job() {
echo Params: $1 $2 $3
ssh $1 "module load slurm  gromacs/2020.3-mpi-gpu; cd ~/_scratch/$2/GMX_run_prep; sbatch -p compute -t 7-00:00:00 -N 4 -J $2 --dependency=afterany:$3 lomo2_run_compute_cont.sh 7_prod"
